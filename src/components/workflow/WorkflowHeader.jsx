...
import { TRIGGER_HINTS, TRIGGER_LABELS, WORKFLOW_TRIGGER_TYPES } from '../../workflow/constants.js'
    ...
    <div className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Field label="מתי התהליך מופעל" hint="טריגר">
          <Select value={workflow.triggerType} onChange={(e) => set({ triggerType: e.target.value })}>
